...
def send_message():
    ...
    sender_email = "adicione o seu email"
    
    sender_password = "adicione a sua senha"
...
app.title("Enviando email")
 
heading = Label(text="Aplicativo para enviar email em Python",bg="yellow",fg="black",font="10",width="500",height="3")
 
heading.pack()
 
address_field = Label(text="Remetente :")
email_body_field = Label(text="Mensagem :")
...
button = Button(app,text="Mensagem enviada",command=send_message,width="30",height="2",bg="grey")
